...
def generate_obj_file(self, weft_count, warp_count, weft_yarns, warp_yarns, output_file):
    """
...
def load_and_validate_yarn_and_pattern():
    ...
    weft_yarn_names, warp_yarn_names = yarn_pattern["wefts"], yarn_pattern["warps"]
